(function () {
	...
	// ignored /home/mandy/frappe-bench/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
		...
		build_version_comments(docinfo, out) {
			...
			docinfo.versions.forEach(function(version) {
				...
				if (data.changed && data.changed.length) {
					...
					if (parts$1.length) {
						out.push(me.get_version_comment(version, __('changed value of {0}', [parts$1.join(', ')])));
					}
				}
